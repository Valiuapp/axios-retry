...
function isNetworkError(error) {
  return (
    ...
    (0, _isRetryAllowed2.default)(error)
...
function axiosRetry(axios, defaultOptions) {
  ...
  axios.interceptors.response.use(null, async function(error) {
    ...
    var _getRequestOptions = getRequestOptions(config, defaultOptions),
      ...
      retryCondition =
        _getRequestOptions$re2 === undefined
      ...
      _getRequestOptions$co = _getRequestOptions.context,
      context = _getRequestOptions$co === undefined ? {} : _getRequestOptions$co;

    var currentState = getCurrentState(config);

    var shouldRetry = currentState.retryCount < retries && (await retryCondition(error, context));
